      ...
      >
        ...
        <section className="glass-card p-10 md:p-16 rounded-[3rem] border-white/5 space-y-10 leading-relaxed text-slate-300">
            <div className="space-y-4">
                ...
                <p>
                    We collect only the necessary marketplace vectors required to facilitate your dropshipping operations. This includes your eBay credentials, Eprolo API keys, and marketplace preference data.
                </p>
            </div>
